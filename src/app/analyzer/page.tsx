  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      ...
      <main id="main-content" className="mx-auto max-w-3xl px-5 pb-16 pt-8 sm:px-6">
        ...
        <Link
          href="/"
          className="mb-4 inline-flex cursor-pointer items-center gap-1.5 text-xs font-medium text-zinc-500 transition hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100"
        >
          <ArrowLeft size={14} />
          Back
        </Link>
